...
const navItems = [
  ...
  {
    label: "Input Pendukung",
    href: "/relawan/pendukung",
  ...
  {
    label: "Distribusi Sembako",
    href: "/relawan/distribusi",
...
export default function RelawanSidebar({ userName }: { userName: string }) {
  return <Sidebar items={navItems} title="Panel Relawan" userName={userName} userRole="Relawan" />;
}
