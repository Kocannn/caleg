...
export default function CalegSidebar({ userName }: { userName: string }) {
  return <Sidebar items={navItems} title="Panel Caleg" userName={userName} userRole="Caleg" />;
}
