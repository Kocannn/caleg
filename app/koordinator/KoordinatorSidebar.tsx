...
const navItems = [
  ...
  {
    label: "Kelola Relawan",
    href: "/koordinator/relawan",
    icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>,
  },
  {
    label: "Data Pendukung",
    href: "/koordinator/pendukung",
  ...
  {
    label: "Logistik",
    href: "/koordinator/logistik",
    icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" /></svg>,
  },
];

export default function KoordinatorSidebar({ userName }: { userName: string }) {
  return <Sidebar items={navItems} title="Panel Koordinator" userName={userName} userRole="Koordinator" />;
}
